...
while 1
  begin
    puts "Ймовірність поглинання (від 0 до 1):"
...
while 1
  begin
    puts "Характеристика взаємодії частинки з речовиною (від 0 до 1):"
    mu = Float(STDIN.gets.chomp)

    if mu > 0 and mu <= 1
      puts("Середня довжина вільного пробігу частинок в речовині:\n#{mu = 1 / mu}")
      break
    else
      puts "Значення поза допустимим діапазоном. Повторіть вибір"
    end
